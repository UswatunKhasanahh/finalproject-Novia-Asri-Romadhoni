...
import noviaasriromadhoni.pmo.aplikasi_wisata.ui.admin.BacaAdmin;
import noviaasriromadhoni.pmo.aplikasi_wisata.ui.admin.CariAdmin;
import noviaasriromadhoni.pmo.aplikasi_wisata.ui.admin.Glide;
import noviaasriromadhoni.pmo.aplikasi_wisata.ui.admin.UpdateAdmin;
...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> implements Filterable {
    ...
    public Adapter(ArrayList<DataKonten> listKonten2, Context context) {
        this.listKonten2 = listKonten2;
        listKonten2_full = new ArrayList<>(listKonten2);
        this.context = context;
        listener2 = (CariAdmin)context;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        Glide.with((BacaAdmin) context).load(imgsumber).into(holder.Gambar);
        ...
        holder.ListItem2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), BacaAdmin.class);
                intent.putExtras(bundle);
                context.startActivity(intent);
            }
        });

        holder.ListItem2.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        switch (i){
                            case 0:
                                ...
                                bundle.putString("dataGambar", listKonten2.get(position).getGambar());
                                bundle.putString("getPrimaryKey", listKonten2.get(position).getKey());
                                Intent intent = new Intent(v.getContext(), UpdateAdmin.class);
                                intent.putExtras(bundle);
                                context.startActivity(intent);
                                break;
                            case 1:
                                listener2.onDeleteData(listKonten2.get(position), position);
                                break;
                        }
                    }
                });
